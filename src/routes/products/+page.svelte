...
<div class="bg-[#0f2942] py-20 relative overflow-hidden">
  ...
  <div class="container mx-auto px-4 relative">
    <div class="flex items-center gap-4 mb-4">
      ...
      <span class="text-[#c9a227] text-sm font-semibold tracking-[0.2em] uppercase">
                    ...
                    <div class="grid grid-cols-2 gap-4 mb-6 pb-6 border-b border-gray-200">
                      <div>
                        <div class="text-xs text-gray-500 uppercase tracking-wide mb-1">
                          {m.products_card_capacity_label()}
                        </div>
                    ...
                    <ul class="space-y-2 mb-6">
                      {#each pair.sany.features?.slice(0, 3) ?? [] as feature}
                        <li class="flex items-start gap-2 text-sm text-gray-700">
                          <svg
                            class="w-4 h-4 text-[#c9a227] mt-0.5 flex-shrink-0"
                            fill="currentColor"
                            viewBox="0 0 20 20"
                          >
                            <path
...
<!-- XCMG Product (Right) -->
{#if pair.xcmg || (pair.capacity !== 150 && pair.capacity !== 200)}
  <a href="/products/{pair.xcmg.slug}" class="group">
    <div class="card-industrial bg-white h-full overflow-hidden">
      ...
      <!-- Content (всё остальное как было) -->
      <div class="p-8">
        ...
        <div class="grid grid-cols-2 gap-4 mb-6 pb-6 border-b border-gray-200">
          <div>
            ...
            <div class="text-lg font-bold text-[#0f2942]">{getProductCapacity(pair.xcmg)}</div>
          </div>
          <div>
            <div class="text-xs text-gray-500 uppercase tracking-wide mb-1">{m.products_card_height_label()}</div>
            <div class="text-lg font-bold text-[#0f2942]">{getProductMaxHeight(pair.xcmg)}</div>
          </div>
        </div>
